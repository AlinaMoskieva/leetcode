...
def rotate_part_of_array(nums, start_pointer, end_pointer)
...
def rotate(nums, k)
  ...
  rotate_part_of_array(nums, 0, k % nums.length - 1)
  rotate_part_of_array(nums, k % nums.length, nums.length - 1) 
